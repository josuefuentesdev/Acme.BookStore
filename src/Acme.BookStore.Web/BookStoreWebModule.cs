...
public class BookStoreWebModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.Conventions.AuthorizeFolder("/Books/Index", BookStorePermissions.Books.Default);
            options.Conventions.AuthorizeFolder("/Books/CreateModal", BookStorePermissions.Books.Create);
            options.Conventions.AuthorizeFolder("/Books/EditModal", BookStorePermissions.Books.Edit);
        });
    }
